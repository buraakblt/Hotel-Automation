...
public class Standart_Customer_for_SingleRoom extends Standart_Customer {

	//Variable for amount
	private double dailyAmount = 100.0;
	
	//Constructor
	public Standart_Customer_for_SingleRoom(String customerID, String customerName, int customerAge) {
