...
public class Private_Customer_for_DoubleRoom extends Private_Customer {

	// Variable for amount
	private double dailyAmount = 150.0;
	
	//Constructor
	public Private_Customer_for_DoubleRoom(String customerID, String customerName, int customerAge) {
